  ...
  return (
    <Screen type={"scroll"} style={{ padding: 25 }}>
      ...
      <View style={[defaultStyles.container, {}]}>
        <Text style={[defaultStyles.baseTextExtraBold, { fontSize: 17, paddingTop: 25 }]}>Data Pesanan </Text>
        <View>
          <Text style={[defaultStyles.baseText, { fontSize: 12, paddingTop: 50 }]}>Sesuai dengan profil</Text>
        </View>
        ...
        <View style={{ paddingTop: 3 }}>
          ...
          <Gap height={22} />
          <Text style={[defaultStyles.baseText2, { alignSelf: "flex-start" }]}>Nama</Text>
          <TextField
          ...
          />
          <Text style={[defaultStyles.baseText, { fontSize: 13, paddingTop: 11 }]}>Isi sesuai dengan tanda pengenal (KTP/SIM dan lainnya)</Text>
          <Gap height={58} />
          <Text style={[defaultStyles.baseText, { alignSelf: "flex-start" }]}>Email</Text>
          <TextField
            inputRef={emailRef}
          ...
          />
          <Gap height={58} />
          <Text style={[defaultStyles.baseText, { alignSelf: "flex-start" }]}>No.Telpn</Text>
          <TextField
        ...
        <View style={{ paddingTop: 40 }}>
          <Button onPress={() => (prevScreen ? submitRegistrationStaff() : submitRegistration())} label="Simpan">
            {isLoading && <Spinner />}
          </Button>
        </View>
        {prevScreen ? (
